...
# Apple touch icons
ADD https://pschapeco.com.br/img/favicon.svg /app/public/apple-icon-57x57.png
ADD https://pschapeco.com.br/img/favicon.svg /app/public/apple-icon-60x60.png
ADD https://pschapeco.com.br/img/favicon.svg /app/public/apple-icon-72x72.png
ADD https://pschapeco.com.br/img/favicon.svg /app/public/apple-icon-76x76.png
ADD https://pschapeco.com.br/img/favicon.svg /app/public/apple-icon-114x114.png
ADD https://pschapeco.com.br/img/favicon.svg /app/public/apple-icon-120x120.png
ADD https://pschapeco.com.br/img/favicon.svg /app/public/apple-icon-144x144.png
ADD https://pschapeco.com.br/img/favicon.svg /app/public/apple-icon-152x152.png
ADD https://pschapeco.com.br/img/favicon.svg /app/public/apple-icon-180x180.png

# Android icons
ADD https://pschapeco.com.br/img/favicon.svg /app/public/android-icon-192x192.png
ADD https://pschapeco.com.br/img/favicon.svg /app/public/android-icon-256x256.png
ADD https://pschapeco.com.br/img/favicon.svg /app/public/android-icon-384x384.png
ADD https://pschapeco.com.br/img/favicon.svg /app/public/android-icon-512x512.png

# Favicon padrão
ADD https://pschapeco.com.br/img/favicon.svg /app/public/favicon.svg
ADD https://pschapeco.com.br/img/favicon.svg /app/public/favicon.ico
